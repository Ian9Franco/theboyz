...
export const CHARACTER_DETAILS = [
  {
    ...
    overloadImage: '/personajes/FULLBODY SUIT/Vesperwing.png',
    color: '#0d3a2b',
  ...
  },
  {
    ...
    overloadImage: '/personajes/FULLBODY SUIT/Oracle.png',
    color: '#f5e642',
  ...
  },
  {
    ...
    overloadImage: '/personajes/FULLBODY SUIT/Wildcard.png',
    color: '#0a1128',
    ...
    powers: {
      ...
      habilidades: [
        'Ecos de Presencia: Genera hasta tres duplicados semisólidos de sí mismo que pueden hablar, pero al decir una verdad, explotan violentamente.',
        'Punto Ciego: Altera la percepción de los rivales para que ignoren temporalmente su presencia.',
        'Verdad Innegable: Decir verdades absolutas interrumpe manipulaciones mentales y sirve como detonador táctico de sus clones.',
        'Movilidad: No vuela, pero escala fácilmente cualquier superficie.',
      ],
      significa: 'El maestro del engaño y el sigilo, capaz de infiltrar defensas y detonar clones cargados de verdades.',
      crisis: 'Detonación por Verdad: Sus copias son inestables ante la honestidad y explotan si dicen una verdad.',
  ...
  },
  {
    ...
    overloadImage: '/personajes/FULLBODY SUIT/Swapfire .png',
    color: '#4c1d95',
    ...
    powers: {
      ...
      habilidades: [
        ...
        'Movilidad: No vuela, pero utiliza su habilidad de intercambio para aparecer instantáneamente donde le plazca.',
      ],
  ...
  },
  {
    ...
    overloadImage: '/personajes/FULLBODY SUIT/AEGIS.png',
    color: '#b91c1c',
  ...
  },
  {
    ...
    overloadImage: '/personajes/FULLBODY SUIT/Null-Vector.png',
    color: '#f95700',
    role: 'Saboteador',
    visualCode: 'remera naranja, ojos celestes, cinturón táctico',
    perfil: [
      'Impulsivo, audaz and con baja reactividad emocional ante el peligro',
    ...
    powers: {
      ...
      habilidades: [
        ...
        'Movilidad: Vuelo natural. Entre más sobrecargado de energía está, más rápido vuela y más destructivo es su paso.',
      ],
  ...
  },
  {
    ...
    overloadImage: '/personajes/FULLBODY SUIT/Hush.png',
    color: '#06b6d4',
    ...
    powers: {
      ...
      habilidades: [
        ...
        'Movilidad: No vuela. Usa pistola de hooks, propulsores sónicos auxiliares y también escala fácilmente.',
      ],
  ...
  },
  {
    ...
    powers: {
      ...
      habilidades: [
        'Ecos de Presencia: Altera la suerte para provocar accidentes ridículos y letales a enemigos.',
  ...
  },
  {
    ...
    powers: {
      ...
      stats: { fuerza: 10, inteligencia: 5, carisma: 8, suerte: 7, combate: 9, defense: 10, especialVal: 10 },
    },
  },
  {
    id: 'coleccionista',
