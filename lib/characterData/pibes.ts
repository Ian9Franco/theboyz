...
export const pibes: CharacterDetail[] = [
  {
    ...
    name: 'Ian',
    category: 'pibes',
    image: '/personajes/PORTADAS/Ian/vesperwing1.png',
    fullBody: '/personajes/PORTADAS/Ian/vesperwing1.png',
    color: '#0d3a2b',
  ...
  },
  {
    ...
    name: 'Jaz',
    category: 'pibes',
    image: '/personajes/PORTADAS/Jaz/Sigil.png',
    fullBody: '/personajes/PORTADAS/Jaz/Sigil.png',
    color: '#f5e642',
  ...
  },
  {
    ...
    name: 'Julián',
    category: 'pibes',
    image: '/personajes/PORTADAS/Julián/Bandit.png',
    fullBody: '/personajes/PORTADAS/Julián/Bandit.png',
    color: '#0a1128',
  ...
  },
  {
    ...
    name: 'Mati',
    category: 'pibes',
    image: '/personajes/PORTADAS/Mati/Farsight.png',
    fullBody: '/personajes/PORTADAS/Mati/Farsight.png',
    color: '#4c1d95',
  ...
  },
  {
    ...
    name: 'Uandi',
    category: 'pibes',
    image: '/personajes/PORTADAS/Uandi/Uandi.png',
    fullBody: '/personajes/PORTADAS/Uandi/Uandi.png',
    color: '#b91c1c',
    ...
    powers: {
      ...
      habilidades: [
        ...
        'Regeneración de Brimstone (Habilidad de Aegis): Si recibe un impacto o herida en estado base, su "otro yo" demoníaco (Aegis) lo cura de forma instantánea, cicatrizando y reparando su cuerpo de manera pasiva y automática sin necesidad de convertirse o transformarse por completo. Uandi no tiene control ni consciencia de esta curación o de sus acciones cuando se transforma.',
  ...
  },
  {
    ...
    name: 'Volvo',
    category: 'pibes',
    image: '/personajes/PORTADAS/Volvo/Outrider.png',
    fullBody: '/personajes/PORTADAS/Volvo/Outrider.png',
    color: '#f95700',
  ...
  },
  {
    ...
    name: 'Sofi',
    category: 'pibes',
    image: '/personajes/PORTADAS/Sofi/Dusk.png',
    fullBody: '/personajes/PORTADAS/Sofi/Dusk.png',
    color: '#06b6d4',
