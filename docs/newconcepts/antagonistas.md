...
Este documento recopila la información de los antagonistas definidos en `lib/characterData/antagonistas.ts` para su revisión y mejora.
...
* **Rol**: Alcalde de Nueva York / Kingpin Institucional
* **Código Visual**: Trajes de sastre impecables a medida, anillo de diamante negro, físico imponente
* **Color**: `#1f2937`
...
### Crisis
Aversión al caos: Las variables estocásticas e irracionales desestabilizan su monopolio financiero calculador.
...
* **ID**: `phobos`
* **Categoría**: `antagonistas`
* **Rol**: El Arquitecto del Pánico / Mente Maestra Táctica
* **Código Visual**: Gabardina de cuero negro balístico pesado con correas y hebillas, cuello rígido, visor angular de hierro oscuro con pinchos geométricos
* **Color**: `#334155`
...
* **El verdugo teatral**: Al ejecutar su caza, adopta posturas exageradas, inclinadas y fluidas. Su sonrisa fija de porcelana y su risa maníaca de frecuencia distorcionada quiebran la cordura de sus presas.

### Crisis
Arrogancia absoluta: Su convicción de que la esperanza y la ética son fallas lógicas lo lleva a subestimar los sacrificios irracionales que los héroes están dispuestos a hacer.
...
* **Combate**: 7
* **Defensa**: 6
* **Especial**: 10 (Geometría del Trauma)

### Poderes / Habilidades (El Diseñador de Dilemas)
* **Significado**: El estratega del pánico. Desestabiliza la mente de sus presas y desmantela el orden social mediante la lógica de la caída.
...
* **ID**: `shinjuro`
* **Categoría**: `antagonistas`
* **Rol**: Oyabun Yakuza / El Dragón de Acero
* **Código Visual**: Kimono negro sobre brazo robótico negro mate, tatuaje de dragón neón
* **Color**: `#0284c7`
...
### Crisis
Código de honor: Su apego a las tradiciones le impide atacar a traición o usar armas de destrucción masiva.
...
* **Combate**: 9
* **Defensa**: 7
* **Especial**: 7 (Monomateria)

### Poderes / Habilidades (Dragón de Acero)
* **Significado**: El verdugo honorable. Se especializa en duelos singulares de precisión milimétrica donde el filo atómico decide el final.
...
* **ID**: `balthazar`
* **Categoría**: `antagonistas`
* **Rol**: Alquimista de Sangre / Nigromante
* **Código Visual**: Gabardina larga de terciopelo vino tinto, bastón de cuervo
* **Color**: `#7f1d1d`
...
* **Combate**: 6
* **Defensa**: 8
* **Especial**: 8 (Nigromancia)

### Poderes / Habilidades (Balthazar)
* **Significado**: El titiritero esotérico. Conjura fuerzas del vacío y materia inerte para asediar posiciones enemigas.
...
* **ID**: `comandante`
* **Categoría**: `antagonistas`
* **Rol**: Jefe de los V.O.P.S. / Brazo Armado de Vanguard
* **Código Visual**: Uniforme táctico blindado negro y azul, visor de luz azul sólido, modulador de voz
* **Color**: `#ef4444`
...
### Crisis
Parálisis doctrinaria: La rigidez de su protocolo lo bloquea cuando enfrenta tácticas caóticas o improvisadas que escapan a sus manuales de contención táctica.
...
### Poderes / Habilidades (Jefe Táctico V.O.P.S.)
* **Significado**: El puño institucional. Ejecuta la agenda encubierta de Don Vanguard con impunidad legal, convirtiendo la persecución de raros en operativo policial rutinario.
...
### Notas de Lore
Versión terrenal. Su versión cósmica — líder de una corporación interdimensional — corresponde a una escala narrativa futura de la saga, cuando la amenaza de los V.O.P.S. trascienda Nueva York.
...
* **Código Visual**: Arnés táctico de sujeción industrial en espalda y cuello, mangueras de polímero reforzado a sienes y brazos, respirador industrial pesado, chaleco de cuero oscuro rasgado
* **Color**: `#15803d`
...
### Crisis
La Trampa del Olvido: Al regresar a su estado base, Gorgon pierde todo recuerdo de sus planes de rebelión y vuelve a ser dócil.
...
* **Combate**: 8
* **Defensa**: 9
* **Especial**: 6 (Metatoxina Durmiente)

### Poderes / Habilidades (El Intelecto Despierto)
* **Significado**: El titán cerebral. Una mente brillante atrapada en un cuerpo de destrucción industrial que juega una guerra fría mental con su captor.
...
* **ID**: `apex`
* **Categoría**: `antagonistas`
* **Rol**: El Proyecto Estabilizado / Operativo de Gobierno
* **Código Visual**: Traje táctico de polímero gris militar, chaleco táctico ligero con arneses y fundas de armas, rostro descubierto con expresión fría
* **Color**: `#475569`
...
* **Combate**: 9
* **Defensa**: 7
* **Especial**: 8 (Fórmula Apex)

### Poderes / Habilidades (El Soldado Perfecto)
* **Significado**: El operativo definitivo del gobierno. Un combatiente de precisión quirúrgica e inmunidad mental total.
...
* **Código Visual**: Traje de polímero oscuro ceñido, casco alargado de alta tecnología que expande y contiene su masa elástica
* **Color**: `#0f172a`
...
* **Combate**: 7
* **Defensa**: 8
* **Especial**: 9 (Elasticidad Cerebral)

### Poderes / Habilidades (La Anomalía Biológica)
* **Significado**: El intelectual mutable. Un villano pulcro y futurista que combina elasticidad anatómica absoluta con un procesamiento cerebral supercomputador.
