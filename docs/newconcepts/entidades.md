...
Este documento recopila la información de las entidades definidas en `lib/characterData/entidades.ts` para su revisión y mejora.
...
* **ID**: `judge_null`
* **Categoría**: `entidades`
* **Rol**: El Árbitro Final
* **Código Visual**: Armadura de obsidiana tipo catedral, corona rota flotante, capa de universos muertos
* **Color**: `#450a0a`
...
### Crisis
Lentitud de juicio: Al representar el fin de la entropía, sus movimientos y ataques tienen un gran tiempo de ejecución.
...
### Poderes / Habilidades (Final Arbiter)
* **Significado**: El heraldo del silencio absoluto. Destruye variables y extingue realidades mediante fuerza colosal.
...
* **ID**: `malakas`
* **Categoría**: `entidades`
* **Rol**: Banquero del Dolor / El Arquitecto del Pacto
* **Código Visual**: Esmoquin de obsidiana victoriana, cabeza de piedra con runas violetas, contratos flotantes
* **Color**: `#86198f`
...
### Crisis
Laguna contractual: Si un héroe encuentra una laguna legal en sus palabras o comete un acto desinteresado, su poder se fractura.
...
### Poderes / Habilidades (Cobrador del Pacto)
* **Significado**: El cobrador de almas. Atrapa y debilita objetivos mediante cadenas de remordimientos y espectros.
...
* **ID**: `terrorblade`
* **Categoría**: `entidades`
* **Rol**: Merodeador del Infierno de Cristal
* **Código Visual**: Silueta de obsidiana, alas curvas de energía fractal verde, guadañas de mano
* **Color**: `#047857`
...
### Crisis
Interferencia de reflejo: Si sus cristales de Foulfell son destruidos, su capacidad de ilusión se cancela.
...
### Poderes / Habilidades (Terrorblade)
* **Significado**: El manipulador de salud. Intercambia la vitalidad del oponente y duplica amenazas mediante ilusiones.
...
* **ID**: `krillor`
* **Categoría**: `entidades`
* **Rol**: Kingpin Cósmico / Plaga Solar
* **Código Visual**: Piel dorada con grabados fractales violetas, bio-armadura de marfil, cola segmentada
* **Color**: `#d1d5db`
...
### Crisis
Desprecio absoluto: Su arrogancia imperial lo lleva a subestimar a los combatientes humanos.
...
* **Combate**: 9
* **Defensa**: 9
* **Especial**: 10 (Gravedad)

### Poderes / Habilidades (Sindicato Cósmico)
* **Significado**: El cobrador de soles. Asedia planetas mediante monopolio de atmósferas y embargos gravitatorios.
...
* **ID**: `balanar`
* **Categoría**: `entidades`
* **Rol**: El Rey de la Noche Urbana
* **Código Visual**: Gárgola vampírica masiva, garras que sacan chispas, alas de murciélago
* **Color**: `#1e3a8a`
...
### Crisis
Vulnerabilidad solar: La luz ultravioleta o destellos de energía de espectro solar (como la magia de Jaz) reducen su fuerza física.
...
### Poderes / Habilidades (Balanar)
* **Significado**: El depredador de las sombras. Deshabilita habilidades y acosa objetivos en la oscuridad absoluta.
...
* **ID**: `freezer`
* **Categoría**: `entidades`
* **Rol**: El Emperador Galáctico
* **Código Visual**: Alienígena de piel blanca y bioarmadura púrpura, mirada fría, aura intimidante y transformaciones devastadoras
* **Color**: `#8b5cf6`
...
### Crisis
Exceso de confianza: Su arrogancia lo lleva a subestimar rivales aparentemente inferiores, permitiendo que sus enemigos encuentren oportunidades para derrotarlo.
...
* **Combate**: 10
* **Defensa**: 9
* **Especial**: 10 (Transformación)

### Poderes / Habilidades (Frieza)
* **Significado**: La encarnación de la dominación absoluta. Combina poder abrumador, crueldad estratégica y una capacidad destructiva capaz de amenazar galaxias enteras.
...
* **ID**: `lion`
* **Categoría**: `entidades`
* **Rol**: El Demonologista Corrupto
* **Código Visual**: Brujo felino jorobado, brazo izquierdo de garra demoníaca roja
* **Color**: `#701a75`
...
* **Combate**: 7
* **Defensa**: 5
* **Especial**: 8 (Dedo de Muerte)

### Poderes / Habilidades (Demonologist)
* **Significado**: Mago ráfaga. Ejecuta eliminación directa de objetivos prioritarios mediante descargas demoníacas extremas.
