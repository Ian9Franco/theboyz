...
Este documento recopila la información de las variantes de Mati (el Consejo de Matis) definidas en `lib/characterData/matis.ts` para su revisión y mejora.
...
* **ID**: `mati_prime`
* **Categoría**: `matis`
* **Rol**: El Arquitecto / Nexo Central
* **Código Visual**: Armadura gris oscuro, líneas LED violetas, visor táctico
* **Color**: `#4b5563`
...
### Crisis
Bucle obsesivo: Su obsesión por el orden lógico lo paraliza si se enfrenta a variables absurdas que escapan a su algoritmo.
...
* **ID**: `gladiador`
* **Categoría**: `matis`
* **Rol**: El Campeón del Foso
* **Código Visual**: Cicatrices en el torso, arnés de cuero, mandoble de plasma
* **Color**: `#b45309`
...
### Crisis
Sed de sangre: Su instinto de gladiador lo empuja a prolongar el combate directo, ignorando retiradas estratégicas.
...
### Poderes / Habilidades (Mati Variant)
* **Significado**: Luchador cinético. Transfiere la fuerza física enemiga para potenciar sus propios ataques de corte.
...
* **ID**: `augusto`
* **Categoría**: `matis`
* **Rol**: El Emperador de Silicio
* **Código Visual**: Toga roja sobre armadura dorada, corona de laureles de fibra óptica
* **Color**: `#991b1b`
...
### Crisis
Orgullo de César: Se niega a retirarse ante amenazas menores, considerándolo un insulto a su dignidad imperial.
...
### Poderes / Habilidades (Mati Variant)
* **Significado**: Comandante de red. Optimiza el desempeño de sus tropas robóticas transfiriendo jerarquías de control.
...
* **ID**: `warden`
* **Categoría**: `matis`
* **Rol**: El Juez de Equivalencia
* **Código Visual**: Túnica oscura de juez, balanza de energía violeta flotante
* **Color**: `#6d28d9`
...
### Crisis
Equivalencia estricta: No puede atacar si el enemigo no ha atacado primero, siguiendo su código de justicia.
...
### Poderes / Habilidades (Mati Variant)
* **Significado**: Juez del nexo. Equilibra el tablero de combate reflejando daños e imponiendo leyes de intercambio equivalente.
...
* **ID**: `astronauta`
* **Categoría**: `matis`
* **Rol**: El Exiliado Orbital / Especialista Extradimensional
* **Código Visual**: Traje espacial negro dañado, luces orbitales tenues, casco con visor trizado
* **Color**: `#1e1b4b`
...
### Poderes / Habilidades (Mati Variant)
* **Significado**: Combatiente táctico espacial. Controla la gravedad local y realiza maniobras tridimensionales rápidas.
...
### Notas de Lore
Miembro de La Órbita Muerta. Starfall descubrió que su universo sobrevivía drenando energía de realidades vecinas. Al intentar exponerlo, fue exiliado y arrojado a una realidad ajena con su traje dañado.
