# Secundarios e Independientes

Este documento recopila la información de los personajes secundarios e independientes definidos en `lib/characterData/secundarios.ts` para su revisión y mejora.
...
* **Rol**: Antiheroína / Karma
* **Código Visual**: Traje de piloto espacial, lentes de cazadora
* **Color**: `#6b7280`
...
### Crisis
Prioridad de supervivencia: Ante un colapso, manipula la suerte para asegurar su propia ruta de escape, desentendiéndose del equipo.
...
* **Combate**: 3
* **Defensa**: 2
* **Especial**: 2 (Efecto Dominó)

### Poderes / Habilidades (Karma)
* **Significado**: La variable del vacío. Domina el caos fortuito y sabotea los sistemas enemigos mediante mala suerte dirigida.
...
* **ID**: `supertrucker`
* **Categoría**: `independientes`
* **Rol**: El Centinela del Asfalto
* **Código Visual**: Gorra cromada, capa de lona roja, faros xenón
* **Color**: `#f97316`
...
### Crisis
Fijación de mantenimiento: Ante cualquier daño menor en sus sistemas mecánicos, prioriza la reparación preventiva sobre la amenaza.
...
* **Combate**: 7
* **Defensa**: 8
* **Especial**: 8 (Embestida)

### Poderes / Habilidades (Supertrucker)
* **Significado**: Tanque pesado motorizado. Su propósito es la demolición absoluta y el control de carril mediante embestidas.
...
* **ID**: `rylai`
* **Categoría**: `taberna_resistencia`
* **Rol**: La Canalizadora de la Tormenta
* **Código Visual**: Capa azul ártico con piel blanca, bastón místico con gema de hielo
* **Color**: `#3b82f6`
...
### Crisis
Vulnerabilidad física: Su magia requiere canalización estática, lo que la vuelve un blanco fácil si logran flanquear sus defensas de hielo.
...
* **Combate**: 4
* **Defensa**: 5
* **Especial**: 8 (Congelación)

### Poderes / Habilidades (Crystal Maiden)
* **Significado**: Control de masas y soporte elemental. Congela el terreno de combate para limitar la movilidad de las amenazas.
...
* **ID**: `bristleback`
* **Categoría**: `independientes`
* **Rol**: El Matón de Callejón
* **Código Visual**: Chaleco vaquero sin mangas, aro en la nariz, lomo de espinas biomecánicas
* **Color**: `#15803d`
...
### Crisis
Furia ciega: Si es insultado o desafiado, pierde el control y ataca de espaldas para forzar su defensa pasiva, ignorando órdenes tácticas.
...
### Poderes / Habilidades (Rigwarl)
* **Significado**: Tanque dispersor. Se planta en el centro de la pelea atrayendo fuego para saturar el entorno de púas y metralla orgánica.
...
* **ID**: `invoker`
* **Categoría**: `independientes`
* **Rol**: El Mago del Arsenal
* **Código Visual**: Cabello blanco ingrávido, capa-gabardina marfil, orbes de energía
* **Color**: `#d97706`
...
### Crisis
Complejo de superioridad: Considera a los humanos tan inferiores que se niega a usar hechizos defensivos básicos, prefiriendo la espectacularidad.
...
* **Combate**: 7
* **Defensa**: 4
* **Especial**: 9 (Invocación)

### Poderes / Habilidades (Kael)
* **Significado**: Artillería mágica omnidireccional. Combina orbes elementales para conjurar soluciones destructivas adaptadas a la situación.
...
* **ID**: `ymir`
* **Categoría**: `taberna_resistencia`
* **Rol**: El Boxeador del Norte
* **Código Visual**: Morsa robusta, chaleco con piel de oso, guantelete de hielo eterno
* **Color**: `#0284c7`
...
### Crisis
Temeridad de taberna: Su amor por el espectáculo lo empuja a rodar en bolas de nieve directo hacia posiciones enemigas fortificadas.
...
* **Combate**: 7
* **Defensa**: 6
* **Especial**: 7 (Walrus Punch)

### Poderes / Habilidades (Ymir)
* **Significado**: Iniciador y luchador cuerpo a cuerpo. Desestabiliza las líneas enemigas mediante embestidas heladas y golpes críticos.
...
* **ID**: `kenji`
* **Categoría**: `secundarios`
* **Rol**: Cocinero Tradicional / Soporte Emocional
* **Código Visual**: Delantal de lona azul, vincha Hachimaki azul oscuro, mirada cansada pero cálida
* **Color**: `#c2410c`
...
### Crisis
Temeridad obstinada: Su rigidez ética y lealtad le impiden someterse a la extorsión de las mafias, prefiriendo resistir de pie.
...
* **ID**: `magnus`
* **Categoría**: `independientes`
* **Rol**: El Señor del Metal / Antihéroe Pragomático
* **Código Visual**: Elegante gabardina/capa negra con forro carmesí oscuro, casco magnético estilizado y acorazado, cabello y barba canosos
* **Color**: `#991b1b`
...
### Crisis
Invalidez magnética: En entornos sin materiales ferrosos o campos magnéticos naturales, su capacidad ofensiva se reduce.
...
* **Combate**: 8
* **Defensa**: 8
* **Especial**: 9 (Magnetismo Alfa)

### Poderes / Habilidades (El Señor del Metal)
* **Significado**: El veterano del magnetismo. Un antihéroe que dobla el metal y los campos magnéticos para proteger a los suyos.
...
* **ID**: `valery`
* **Categoría**: `independientes`
* **Rol**: Bruja de la Tinta Primordial / Antiheroína
* **Código Visual**: Grimorio antiguo de cuero oscuro, vestido midi bohemio, lentes de carey
* **Color**: `#1e1b4b`
...
### Crisis
Vínculo del Libro: Si el grimorio es cerrado, destruido o separado de ella, la Tinta Viva se disuelve y pierde sus defensas y poder mágico.
...
* **Combate**: 8
* **Defensa**: 8
* **Especial**: 10 (Pacto del Grimorio)

### Poderes / Habilidades (Soberana de la Tinta)
* **Significado**: Hechicera de Control y Vanguardia Líquida. Absorbe la esencia mágica de seres caídos y controla el campo con fluidos oscuros.
...
* **ID**: `aurelia`
* **Categoría**: `secundarios`
* **Rol**: La Cartógrafa Blanca / Astrónoma del Fin
* **Código Visual**: Túnica blanca, marcas de mapas estelares biológicos en la piel, bastón de navegación estelar
* **Color**: `#cbd5e1`
...
### Crisis
Remembranza dolorosa: Intentar manifestar coordenadas de Elyndra le genera una intensa disonancia cognitiva y fatiga física.
...
* **Combate**: 5
* **Defensa**: 6
* **Especial**: 9 (Navegación)

### Poderes / Habilidades (Cartógrafa Astral)
* **Significado**: La navegante de la realidad. Abre y cierra accesos interdimensionales guiando al grupo por caminos seguros.
...
### Notas de Lore
Miembro de La Órbita Muerta. Aurelia pertenece a los Elyndari, especie que cartografiaba y conectaba mundos. Su planeta natal Elyndra fue "removido" de la realidad por una fuerza desconocida. Ella es el último mapa vivo de un mundo que nadie recuerda.
...
* **ID**: `john_wick`
* **Categoría**: `secundarios`
* **Rol**: El Diurno / Baba Yaga
* **Código Visual**: Traje negro a medida, mirada implacable, estaca táctica de plata, espada corta Luto, revolver tallado con marcas antivampiricas.
* **Color**: `#1c1917`
...
### Crisis
Sed de sangre: Luchar contra su propia naturaleza dhampir consume su autocontrol si se expone a heridas sagradas o plata.
...
* **Combate**: 10
* **Defensa**: 8
* **Especial**: 8 (Baba Yaga)

### Poderes / Habilidades (Diurno)
* **Significado**: El ejecutor de la noche. Limpia salones de enemigos mediante fuerza híbrida y precisión balística absoluta.
...
### Notas de Lore
Conocido como Baba Yaga y temido en el mundo oculto como El Diurno, John Wick fue traicionado por la Mesa Carmesí. Quedó transformado en un dhampir con fuerza y regeneración aumentadas, pero todavía dueño de su voluntad. Ahora caza vampiros buscando cobrar con sangre.
...
* **ID**: `lucian`
* **Categoría**: `secundarios`
* **Rol**: El Exorcista Maldito / Abogado del Desastre
* **Código Visual**: Gabardina gastada, cigarrillo encendido, Fósforo de San Judas, bolsa de reliquias robadas
* **Color**: `#292524`
...
### Crisis
Plazo de cobro: Malphas y sus cobradores acechan constantemente, obligándolo a gastar energía para evitar su descenso.
...
* **Combate**: 6
* **Defensa**: 5
* **Especial**: 8 (Exorcismo)

### Poderes / Habilidades (Ocultista)
* **Significado**: El negociador maldito. Desactiva ventajas demoníacas y manipula las reglas del combate místico.
...
### Notas de Lore
Un ocultista y exorcista maldito de Saint Marrow condenado al Infierno. Graves sobrevive resolviendo casos sobrenaturales mientras navega una red de pactos y figuras infernales que lo odian y lo necesitan, usando el Fósforo de San Judas y su bolsa de reliquias robadas.
...
* **ID**: `mando`
* **Categoría**: `secundarios`
* **Rol**: El Errante del Polvo / Cazador de Órbitas Muertas
* **Código Visual**: Armadura de combate abollada, casco con tres ranuras azules Ghostline, capa de camuflaje térmico
* **Color**: `#334155`
...
### Crisis
Fantasmas de Ghostline: Su visor táctico muestra ecos térmicos del pasado, distorsionando su enfoque en combate.
...
* **Combate**: 9
* **Defensa**: 8
* **Especial**: 7 (Ghostline)

### Poderes / Habilidades (Cazarecompensas)
* **Significado**: El soldado de asalto. Rastrea objetivos invisibles y resiste daños masivos gracias a su blindaje.
...
### Notas de Lore
Miembro de La Órbita Muerta. Antiguo soldado colonial sobreviviente de Veyra-9, donde su escuadrón y una colonia entera desaparecieron tras una señal cósmica. Acepta contratos mientras rastrea pistas sobre el origen de la señal a bordo de su nave, El Cuervo de Veyra.
...
* **ID**: `vexa`
* **Categoría**: `secundarios`
* **Rol**: La Cazadora de Vidrio / Ejecutora de Órbita Limpia
* **Código Visual**: Cuerpo translúcido con núcleo de energía, armadura biomecánica blanca y dorada, garras de vidrio
* **Color**: `#0891b2`
...
### Crisis
Sincronía inestable: Su núcleo entra en resonancia violenta y pierde control al acercarse al Ghostline de Mando.
...
* **Combate**: 9
* **Defensa**: 7
* **Especial**: 8 (Probabilidad)

### Poderes / Habilidades (Blue Wraith)
* **Significado**: La cazadora sigilosa. Se infiltra tras líneas enemigas y neutraliza objetivos clave con precisión clínica.
...
### Notas de Lore
Miembro de La Órbita Muerta. Cazadora de élite biomecánica cuyos sistemas de probabilidad son extremadamente precisos. Posee un núcleo de energía recuperada de Veyra-9, y al acercarse a Mando, su núcleo reacciona al Ghostline de su casco.
