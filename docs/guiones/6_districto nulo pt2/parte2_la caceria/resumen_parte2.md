...
* **La marca y la separación (Págs. 66-69):** Carmella marca el cuello de Julián en el club para saldar la deuda. Ian, consciente de que el visor cuántico de Mati está fallando gravemente, decide separarse del grupo para buscar una solución de hardware con Norman Parker.

### Acto 4 — "El Creador Elástico (The Maker)" (Páginas 70 a 72)
* **El pacto (Págs. 70-71):** Ian se reúne con Norman Parker en un bar rústico de madera. Norman le entrega una tarjeta de acceso a un estabilizador cuántico a cambio de un favor futuro no especificado, obligando a Ian a comprometerse moralmente.
* **Traslado a la Torre (Pág. 72):** Viajan en limusina blindada hacia la Parker Tower mientras V.O.P.S. rastrea el parque.

### Acto 5 — "El Límite del Nexo" (Páginas 73 a 74)
* **El dilema de Jaz (Pág. 73):** Ian regresa al penthouse con la tarjeta. Jaz rechaza de plano entrar a los dominios corporativos de Parker y decide quedarse atrás. El resto de los chicos decide marchar a la torre.
* **Ingreso a Parker Tower (Pág. 74):** Los chicos acceden a las instalaciones de alta tecnología. Desde el ático, Norman Parker los observa; su reflejo revela momentáneamente una alarmante inestabilidad y elasticidad celular. Las pantallas de la oficina comienzan a registrar las firmas biométricas de Aegis e Ian.

---

## 📈 Ficha de Estado Narrativo (Fin de Parte 2)
* **Ubicación del Grupo:** Parker Tower (Bajo protección y vigilancia corporativa).
* **Estado de Mati:** Temporalmente estable gracias al visor, pero con su firma cuántica expuesta al sistema informático de Parker.
* **Estado de Los Pibes:** Fugitivos oficiales de la ley, sin base en Dumbo y divididos (Jaz permanece en su penthouse).
* **Estado de los Enemigos:**
  * **Norman Parker (The Maker):** Ha alojado al grupo en su torre, obteniendo acceso directo a sus lecturas biométricas y ligando a Ian a un favor futuro.
  * **Don Vanguard y V.O.P.S.:** Mantienen el control militar de la ciudad y el estado de sitio.
  * **Gorgon:** En libertad en el alcantarillado tras desgastar a Aegis en combate.
