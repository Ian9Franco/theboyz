      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-1.5">
              {!isCinematic && (
                <button
                  ...
                  className="px-2 py-0.5 bg-zinc-800 hover:bg-zinc-700 text-white font-bold rounded text-xs active:scale-95 transition-all cursor-pointer border border-white/10"
                  title="Negrita"
                >
                  B (Negrita)
                </button>
          ...
          <textarea
            ...
            className="w-full h-24 border border-white/15 p-2.5 text-xs font-sans bg-[#0a0a0f] text-white resize-none focus:outline-none focus:ring-2 focus:ring-[#e8185a] rounded transition-all"
