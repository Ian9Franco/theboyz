...
const POWER_ORIGINS = [
  ...
  { id: "uandi",  title: "UANDI / AEGIS",     desc: "Absorbió la mayor exposición a la radiación arcana. Su estructura dérmica mutó, permitiéndole asimilar impactos físicos directamente en sus tatuajes tribales para acumularlos y devolverlos en descargas o súper saltos cinéticos." },
...
const ALIAS_ORIGINS = [
  { id: "julian", name: "Julián → Wildcard",  text: "No viene de sus poderes, sino de su personalidad caótica. En una misión táctica, cuando saca 'una carta buena' improvisada de estática azul que salva la retirada, Mati lo bautiza como un wildcard literal.", extra: "Llama 'wachin' o 'wacha' para berretinear dependiendo del género. A su novia misteriosa le dice 'wawi'." },
  ...
  { id: "uandi",  name: "Uandi → Aegis",      text: "Aparece después de que Uandi se pone delante del grupo para recibir un impacto colosal de artillería. Alguien comenta: 'Ese tipo es un escudo.' A lo que Ian responde: 'No es un escudo. Es una maldita Aegis.'", extra: "Toma mate, maneja y amaga con cocinar asado que termina en guiso. Llama a otros 'pibe', 'loco' o 'maestro'." },
